...
namespace Package\Difference\Fun\Config\Controller;
...
class Cli extends Controller {
    ...
    const INFO = [
        '{{binary()}} difference_fun/config                  | Config (Object store) options',
        '{{binary()}} difference_fun/config setup            | Config setup',
        '{{binary()}} difference_fun/config framework ...    | environment <environment>'
    ];
